...
// disable block copy kernel on non-NPU backend
  ...
  options.model_path(FLAGS_model)
      ...
      .pld_enable_adaptive(FLAGS_pld_enable_adaptive)
      .pld_adaptive_window_size(FLAGS_pld_adaptive_window_size)
      .pld_adaptive_disable_steps(FLAGS_pld_adaptive_disable_steps)
      .pld_adaptive_min_draft_hit_rate(FLAGS_pld_adaptive_min_draft_hit_rate)
      .pld_adaptive_min_accept_rate(FLAGS_pld_adaptive_min_accept_rate)
