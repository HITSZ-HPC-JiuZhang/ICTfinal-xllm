...
class ArgumentParser:
    def __init__(self) -> None:
        ...
        self.parser.add_argument('--speculative_algorithm', type=str, default='MTP', help='Speculative decoding algorithm: MTP, Eagle3, Suffix, PLD, or PromptLookup.')
        self.parser.add_argument('--speculative_suffix_cache_max_depth', type=int, default=64, help='Maximum suffix tree depth for suffix/PLD speculative decoding.')
        self.parser.add_argument('--speculative_suffix_max_spec_factor', type=float, default=1.0, help='Suffix/PLD max tokens factor relative to match length.')
        self.parser.add_argument('--speculative_suffix_max_spec_offset', type=float, default=0.0, help='Suffix/PLD max tokens additive offset.')
        self.parser.add_argument('--speculative_suffix_min_token_prob', type=float, default=0.1, help='Minimum token probability used in suffix/PLD speculation.')
        self.parser.add_argument('--speculative_suffix_max_cached_requests', type=int, default=-1, help='Maximum globally cached requests for suffix/PLD speculation.')
        self.parser.add_argument('--speculative_suffix_use_tree_spec', action='store_true', help='Use tree-based suffix speculation instead of path speculation.')
